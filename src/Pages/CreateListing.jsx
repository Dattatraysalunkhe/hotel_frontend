...
function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='text-4xl font-medium text-center my-7'>Create Listing</h1>

      <form onSubmit={handleSubmit} action="" className='flex flex-col sm:flex-row gap-4'>

        <div className="flex flex-col gap-4 flex-1">
          <input type="text" placeholder='Property Name' id='name' maxLength={200} minLength={2} required className='border p-2 rounded-lg shadow-md' onChange={handleChange} value={formData.name} />
          ...
          <input type="email" placeholder='Email' id='email' className='border p-2 rounded-lg shadow-md' value={formData.email} onChange={handleChange} />
          <input type="number" placeholder='+00 Phone' id='phonenumber' className='border p-2 rounded-lg shadow-md' value={formData.phonenumber} onChange={handleChange}/>
          <input type="number" placeholder='Whats App' id='whatsapp' className='border p-2 rounded-lg shadow-md' value={formData.whatsapp} onChange={handleChange}/>
